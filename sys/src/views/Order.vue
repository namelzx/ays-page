        ...
        <div class="OrderHe">
            ...
            <div class="Tabs" v-if="Tinum===0">
                <div class="Tabslist">
                    ...
                    <van-tabs v-model="num" color="#333333" :swipe-threshold="5" line-height="4px" :border="false"
                              title-active-color="#333333" :ellipsis="false" title-inactive-color="#666666">
                        <van-tab v-for="(item,index) in tabs" :title="item.tabname">
