...
<!-- 编辑我的资料---更新版 -->
    <div>
        ...
        <div>
            <div class="datum_haed"><img src="@/assets/portrait.png" /></div>
            <div class="datum-username">
                <div>姓名</div>
                <div class="username-contens" @click="clickUsers">
                    <div class="contens-title">{{username}}</div>
            ...
            <div class="datum-username">
                ...
                <div class="username-contens" @click="clickPhone">
                    <div class="contens-title">{{phone |phoneNum}}</div>
                    <div class="contens-icon"><img src="@/assets/you.png" /></div>
                </div>
            </div>
      ...
      <div class="up-users" v-if="Upusers" @touchmove.prevent>
        <div class="usersBox">
          <div class="usersBoxHe">
            ...
            <div class="inps">
              <input v-model="username" maxlength="10" @input="descInput" />
...
export default {
    ...
    methods:{
        ...
        descInput() {
            var txtVal = this.username.length;
