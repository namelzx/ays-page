        ...
        <div class="order-wrap">
            ...
            >
                <div class="card-item">
                    ...
                    <div class="upload-btn" @click="toggleConfirm(item.id,item.id)">上传图文</div>
                </div>
            </div>
        </div>
        ...
        <div class="big-confirm" v-if="showBinConfirm">
            <div class="confirmBox">
                ...
                <div class="conf-character">
                    ...
                    <div class="conf-order">安装前后图文</div>
                </div>
                <div class="conf-btn">
...
<script>
    ...
    import {GetIdBy2DayImagesOrder} from "@/api/order";
    ...
    export default {
        ...
        methods: {
            ...
            clickToUpload() {
                let id = this.orderId;
                this.$router.push({path: "/case", query: {id: id}});
            },
            getlist(){
                GetIdBy2DayImagesOrder(this.listQuery).then(res=>{
                    console.log(res)
