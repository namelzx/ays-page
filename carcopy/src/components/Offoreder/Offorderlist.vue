<template>
  <div class="orderlist">
    <div class="list" v-for="(item,index) in orderlist" :key="index">
          ...
          <div class="con-matter">
            ...
            <div class="matter-letter">
              ...
              <div class="letter-time">
                <div class="time-num">
                  <span>2019.11.02 12:20:00</span>
                  <span class="num-sum">共1件</span>
                </div>
              </div>
            </div>
      ...
      <!--  已核销  -->
      <div v-if="item.progress==2" @click="toggleProduct(2)">
        <div class="cancel">
          <div class="cancel-title">
            <div class="title-name">欧大师车灯升级</div>
      ...
      <div v-if="item.progress==3" @click="toggleProduct(3)">
        <div class="cancel">
          <div class="cancel-title">
            <div class="title-name">欧大师车灯升级</div>
            <div class="title-status">已退货</div>
          </div>
          <div class="cancel-content">
            <div class="content-imgs">
              <img src="../../assets/mortgage-img.png" />
      ...
      <!-- <div class="content" v-if="item.progress==2">
        <div class="middle" :style="backgroundDiv">
          <div class="middle-name">已退货</div>
        </div>
        <div class="contentHe">
          <div class="con-title">200抵400 到店还有精美礼品</div>
          <div class="con-matter">
            <div class="matter-imgs">
              <img src="../../assets/mortgage-img.png" />
            </div>
    ...
    <!-- 输入核销码  -->
    <div class="code-input" v-if="cancel">
      <div class="code-wrap">
        <template v-if="!slipSucc">
          ...
          <div class="code-ipns">
            ...
            <van-search placeholder="请输入核销码" input-align="center" v-model="codevalue" />
          </div>
